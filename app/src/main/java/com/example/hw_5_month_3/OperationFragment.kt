package com.example.hw_5_month_3
...
import com.example.hw_5_month_3.databinding.FragmentOperationBinding
        ...
        binding.btn1.setOnClickListener {
            if (!itsWasTen) {
                ...
                if (binding.textView.text.toString() == "0") {
                    val bundle = Bundle()
                    bundle.putString("Result", binding.edText.text.toString())
